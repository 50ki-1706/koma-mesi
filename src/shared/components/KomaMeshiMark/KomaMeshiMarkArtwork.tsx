/**
 * コマメシのブランドマーク（時計と大学の建物）を構成するSVG要素群を提供する。
 * KomaMeshiMarkとKomaMeshiLogoの両方から共有される、外側の<svg>を持たないフラグメント。
 */

/**
 * ブランドマークのSVG要素群を描画する。
 *
 * @returns <svg>の子要素として配置するSVGフラグメント。
 */
export function KomaMeshiMarkArtwork() {
  return (
    <>
      <g
        fill="none"
        stroke="var(--color-mark-brand)"
        strokeWidth="68"
        strokeLinecap="butt"
      >
