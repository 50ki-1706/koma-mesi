...
INSERT INTO `__new_user_preferences`("id", "user_id", "campus_address", "campus_latitude", "campus_longitude", "created_at", "updated_at") SELECT "id", "user_id", "campus_address", "campus_latitude", "campus_longitude", "created_at", "updated_at" FROM `user_preferences`;--> statement-breakpoint
